...
const ListaMaestra = ({ mantenimiento}) => {

 const linkAgregar = `/crear-${mantenimiento.nombre}`
  ...
  useEffect(() => {
    dispatch(getMaestras(mantenimiento.codigo, page, rowsPerPage));
  }, []);
  ...
  const handleDelete = () => {
    if (rows.length === 1) {
      ...
      setPage(update);
      dispatch(eliminarMaestra(mantenimiento.codigo,data.idMaestra, update, rowsPerPage));
    } else {
      dispatch(eliminarMaestra(mantenimiento.codigo,data.idMaestra, page, rowsPerPage));
    }
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Button
                          ...
                          color="primary"
                          component={Link}
                          to={`/${mantenimiento.nombre}/edit/${row.idMaestra}`}
                        >
                          Editar
                        </Button>
                      </TableCell>
